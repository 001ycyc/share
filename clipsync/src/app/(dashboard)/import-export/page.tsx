...
import { exportAsJSON, exportAsCSV } from "@/lib/import-export/exporter";
import {
  parseJSONImport,
  parseCSVImport,
  type ImportPreview,
...
export default function ImportExportPage() {
  ...
  const handleConfirmImport = () => {
    ...
    const newCount = importPreview.totalItems - importPreview.duplicates;
    toast.success(
      `成功导入 ${newCount} 条新记录${importPreview.duplicates > 0 ? `，已跳过 ${importPreview.duplicates} 条重复记录` : ""}`
    );
